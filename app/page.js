...
const TYPE_ALIASES = {
  ...
  "코끼리": "코끼리자전거",
  "자동상하지": "자동상하지자전거", "자동하지": "자동상하지자전거", "자동상지": "자동상하지자전거",
  "tilt": "서기(Tilt)", "서기tilt": "서기(Tilt)", "서기(tilt)": "서기(Tilt)",
  "st": "서기(ST)", "서기st": "서기(ST)", "서기(st)": "서기(ST)",
  "큐보드": "서기(큐보드)", "서기큐보드": "서기(큐보드)",
  "트래드밀": "트래드밀", "treadmill": "트래드밀",
  "스텝퍼": "스텝퍼", "stepper": "스텝퍼",
  "발자전거": "발자전거",
  "계단": "계단", "평행봉": "평행봉",
  "stim": "연하전기(Stim plus)", "연하전기": "연하전기(Stim plus)",
  "rs": "순차적연하전기(RS Stim)", "순차적연하": "순차적연하전기(RS Stim)",
};
